...
pub fn with_where_predicates(
    ...
    generics.make_where_clause().predicates.extend(predicates.into_iter());
...
pub fn with_where_predicates_from_fields<F>(
    generics: &syn::Generics,
    fields: &[F],
    mapper: impl Fn(&F) -> Vec<syn::WherePredicate>,
) -> syn::Generics {
    let predicates = fields.into_iter().flat_map(mapper);
