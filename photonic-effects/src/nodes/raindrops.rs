...
where
    Rate: BoundAttrDecl<Value = f64>,
    Color: UnboundAttrDecl<Value = Range<HSLColor>>,
    Decay: BoundAttrDecl<Value = Range<f64>>,
{
    type Element = HSLColor;
...
where
    Rate: Attr<Value = f64>,
    Color: Attr<Value = Range<HSLColor>>,
    Decay: Attr<Value = Range<f64>>,
{
